...
public class ProfessionDataServiceV1 {
    ...
    public ViewProfessionDetails findProfessionDetails(String prCode) {
        ...
        viewProfessionDetails.setEmploymentRateBefore3(professionDetails.getEmploymentRateBefore3());
        viewProfessionDetails.setEmploymentSalaryBefore3(professionDetails.getEmploymentSalaryBefore3());
        viewProfessionDetails.setEmploymentRateBefore2(professionDetails.getEmploymentRateBefore2());
        viewProfessionDetails.setEmploymentSalaryBefore2(professionDetails.getEmploymentSalaryBefore2());
        viewProfessionDetails.setEmploymentRateBefore1(professionDetails.getEmploymentRateBefore1());
        viewProfessionDetails.setEmploymentSalaryBefore1(professionDetails.getEmploymentSalaryBefore1());
        ...
        viewProfessionDetails.setConstructionSituation(professionDetails.getConstructionSituation());
